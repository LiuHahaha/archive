...
/* node struct for the doubly-linked lists used to maintain the free lists */
typedef struct NODE
{
  int *data;         /*  */
  struct NODE *next;  /* pointer to next node; null for the end of the list */
  struct NODE *prev;  /* pointer to previous node */
} NODE;

static char *heap_listp;

static NODE *heap_lists[]; /* array of explicit free list */
