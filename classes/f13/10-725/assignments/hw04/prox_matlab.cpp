...
// % $ mex prox_matlab.cpp 
// % in matlab to compile.


void prox_dp(int n, double *y, double lam, double *beta) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  if (3!=nrhs || 1!=nlhs){
    mexErrMsgTxt("wrong number inputs/outputs. 3 inputs and 1 output required.");
  }
  
  double *dummy, *y, *lam, *beta;
  size_t n;
