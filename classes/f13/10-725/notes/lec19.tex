...
\lecture{19}{October 29}{Barnabas Poczos/Ryan Tibshirani}{Shashank Singh}
...
Here is a citation, just for fun~\cite{FA}.

\section*{References}
\beginrefs
\bibentry{FA}{\sc F.~Alizadeh},
``Interior point methods in SDP with applications to combinatorial
optimization.''
\bibentry{BV}{\sc S.~Boyd} and {\sc L.Vandenberghe}, 
``Semidefinite Programming.''
\bibentry{LL}{\sc L.~Lovasz},
``Semidefinite programs and combinatorial optimization.''
\bibentry{RF}{\sc R.~Freund},
